...
plot(dados, col="red", main="Dados Barsileiros", xlab="Ano", plot.type = "single")                   #Cria um único gráfico com as três séries juntas, com linhas azuis
plot(dados, col=c("red","blue","green"), main="Dados Barsileiros", xlab="Ano", plot.type = "single")   #Cria um único gráfico com as três séries juntas, com linhas azuis para  PIB, vermelha para trabalho e verde para o câmbio
